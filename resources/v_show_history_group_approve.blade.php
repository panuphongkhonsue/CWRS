...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-13">
            <div class="card">
                <div class="bold_header mx-5" style="line-height:20px">{{ __('เบิกสวัสดิการแบบสันทนาการ') }}
                        ...
                        <div class="row mt-2">
                            <div class="card px-4 py-3 pb-4 border-0" style=" background-color: #eee;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <small id="formGroupExampleInput" class="form-text text-muted ">{{ __('วันที่รับรอง') }}</small>
                                    </div>
                                    <div class="col">
                                        <small id="formGroupExampleInput" class="form-text text-muted ">{{ __('วันที่อนุมัติ') }}</small>
                                    </div>
                                </div>
