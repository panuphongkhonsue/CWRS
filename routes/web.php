...
Route::group(['middleware' => 'auth'], function()
{
   ...
   {
        Route::get('/request_single', [Request_controller::class, 'single_request'])->name('s.request');
        Route::post('/request/single/create', [Request_controller::class, 'create_single'])->name('create.single');
        Route::get('/request_group', [Request_controller::class, 'group_request'])->name('group_request');
